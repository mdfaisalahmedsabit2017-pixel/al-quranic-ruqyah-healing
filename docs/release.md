...
**অ্যাডমিন হিসাব ট্যাব (💰) — প্রতিটি রিলিজে দেখে নিতে হবে।** এটা মালিকের
**ব্যক্তিগত** bKash/Nagad/Rocket/ব্যাংক খতিয়ান, তাই APK-তে যাওয়া চলবে না —
কারণ **গোপনীয়তা**, Play Billing নয় (পাশাপাশি পলিসি-ঝুঁকিও আছে, কারণ ওটা ঠিক
সেই শব্দভাণ্ডারই ব্যবহার করে যা রিভিউয়ার grep করে)। `npm run audit:native` আর
`npm run smoke` দুটোই এটা ঢেকে রাখে — যাচাই করা হয়েছে যে **দুই ধরনের ভুলই
ধরা পড়ে**: মার্কার একটা মুছলে বিল্ড ফাইল:লাইন দিয়ে ফেল করে, আর দুটোই মুছলে
(তখন balance ঠিক থাকে, বিল্ড পাস করে) অডিট `fin-balgrid` ও মার্কআপে রাখা
উদ্দেশ্যমূলক `৳` ধরে ফেল করে। দ্রুত হাতে-যাচাই:

```powershell
Select-String -Path native/index.html -Pattern "fin-balgrid" ; # কিছু আসবে না
Select-String -Path native/app.js    -Pattern "api/finance"  ; # কিছু আসবে না
```
