...
> **ব্যক্তিগত (individual) Play Console অ্যাকাউন্টে প্রোডাকশনের আগে একটানা
> ১৪ দিনের ক্লোজড টেস্ট বাধ্যতামূলক**, নির্দিষ্টসংখ্যক টেস্টার নিয়ে। ঘড়িটা
> প্রথম ক্লোজড-টেস্ট রিলিজ থেকে চালু হয় — তাই যত আগে শুরু করবেন তত ভালো,
> আর ওই ১৪ দিনেই UI-র কাজ আপডেট হিসেবে পাঠানো যাবে।
